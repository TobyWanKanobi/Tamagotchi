...
namespace UnitTestProject.ServiceReference1 {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="Tamagotchi", Namespace="http://schemas.datacontract.org/2004/07/TamagotchiWcfService.Model")]
    ...
    public partial class Tamagotchi : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        private System.DateTime ActionStartedField;
        ...
        public System.DateTime ActionStarted {
            get {
                return this.ActionStartedField;
            }
            set {
                if ((this.ActionStartedField.Equals(value) != true)) {
                    this.ActionStartedField = value;
                    this.RaisePropertyChanged("ActionStarted");
                }
            }
        }
    ...
    public interface ITamagotchiService {
        ...
        UnitTestProject.ServiceReference1.Tamagotchi GetTamagotchiByName(string Name);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITamagotchiService/GetTamagotchiByName", ReplyAction="http://tempuri.org/ITamagotchiService/GetTamagotchiByNameResponse")]
        System.Threading.Tasks.Task<UnitTestProject.ServiceReference1.Tamagotchi> GetTamagotchiByNameAsync(string Name);
        ...
        UnitTestProject.ServiceReference1.Tamagotchi[] GetTamagotchies();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITamagotchiService/GetTamagotchies", ReplyAction="http://tempuri.org/ITamagotchiService/GetTamagotchiesResponse")]
        System.Threading.Tasks.Task<UnitTestProject.ServiceReference1.Tamagotchi[]> GetTamagotchiesAsync();
        ...
        UnitTestProject.ServiceReference1.Tamagotchi ExecuteAction(TamagotchiWcfService.Contract.ActionContract contract);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITamagotchiService/ExecuteAction", ReplyAction="http://tempuri.org/ITamagotchiService/ExecuteActionResponse")]
        System.Threading.Tasks.Task<UnitTestProject.ServiceReference1.Tamagotchi> ExecuteActionAsync(TamagotchiWcfService.Contract.ActionContract contract);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ITamagotchiServiceChannel : UnitTestProject.ServiceReference1.ITamagotchiService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class TamagotchiServiceClient : System.ServiceModel.ClientBase<UnitTestProject.ServiceReference1.ITamagotchiService>, UnitTestProject.ServiceReference1.ITamagotchiService {
        ...
        public UnitTestProject.ServiceReference1.Tamagotchi GetTamagotchiByName(string Name) {
            return base.Channel.GetTamagotchiByName(Name);
        }
        
        public System.Threading.Tasks.Task<UnitTestProject.ServiceReference1.Tamagotchi> GetTamagotchiByNameAsync(string Name) {
            return base.Channel.GetTamagotchiByNameAsync(Name);
        }
        
        public UnitTestProject.ServiceReference1.Tamagotchi[] GetTamagotchies() {
            return base.Channel.GetTamagotchies();
        }
        
        public System.Threading.Tasks.Task<UnitTestProject.ServiceReference1.Tamagotchi[]> GetTamagotchiesAsync() {
            return base.Channel.GetTamagotchiesAsync();
        }
        
        public UnitTestProject.ServiceReference1.Tamagotchi ExecuteAction(TamagotchiWcfService.Contract.ActionContract contract) {
            return base.Channel.ExecuteAction(contract);
        }
        
        public System.Threading.Tasks.Task<UnitTestProject.ServiceReference1.Tamagotchi> ExecuteActionAsync(TamagotchiWcfService.Contract.ActionContract contract) {
